...
import com.cyberwolf.musicplayer.fragments.AlbumDetailFragment;
import com.cyberwolf.musicplayer.fragments.ArtistDetailFragment;
import com.cyberwolf.musicplayer.fragments.FoldersFragment;
import com.cyberwolf.musicplayer.fragments.HomeFragment;
import com.cyberwolf.musicplayer.fragments.MainFragment;
import com.cyberwolf.musicplayer.fragments.PlaylistFragment;
import com.cyberwolf.musicplayer.fragments.QueueFragment;
import com.cyberwolf.musicplayer.permissions.Nammu;
import com.cyberwolf.musicplayer.permissions.PermissionCallback;
import com.cyberwolf.musicplayer.slidinguppanel.SlidingUpPanelLayout;
import com.cyberwolf.musicplayer.utils.Constants;
...
public class MainActivity extends BaseActivity implements ATEActivityThemeCustomizer, HomeFragment.ThemeChanged {
    private static int SPLASH_TIME_OUT = 4000;
    private Typeface hero;
    ...
    public void themechanged(int value) {
        //changed ambient themes to support both light and dark themes LOLOL
        if(value==2) {
          //  if (isDarkTheme) {
            ...
            //} else {
                ...
                //appbackground.animate().alpha(1.0f).setDuration(1500);
           // }
        }else if(value!=2||value==1){
                appbackground.setVisibility(View.GONE);
                shade.setVisibility(View.GONE);
           // appbackground.setAlpha(0.0f);
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        AppRate.with(this).setInstallDays(7).setLaunchTimes(10).setRemindInterval(7).monitor();
        ...
        shade.getBackground().setAlpha(50);
        shade.setVisibility(View.GONE);

        appbackground = (ImageView)findViewById(R.id.appbackground);
        //appbackground.setVisibility(View.VISIBLE);
        ...
        if(value==2) {
            ...
            appbackground.setVisibility(View.VISIBLE);
            shade.setVisibility(View.VISIBLE); //changed from visible to gone to set ambient themes as default LOLOL
        }
...
*/
        ...
        songtitle.setTypeface(hero);
        songartist.setTypeface(hero);
    ...
    private void checkPermissionAndThenLoad() {
        ...
        if (Nammu.checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE)&&Nammu.checkPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            if (Nammu.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)&&Nammu.shouldShowRequestPermissionRationale(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                Snackbar.make(panelLayout, "We will need to read external storage to display songs on your device.",
    ...
    private void setupNavigationIcons(NavigationView navigationView) {
        ...
        if (!isDarkTheme) { //changed from !isDarkTheme LOLOL
    ...
    public void setDetailsToHeader() {
        ...
        ImageLoader.getInstance().displayImage(TimberUtils.getAlbumArtUri(MusicPlayer.getCurrentAlbumId()).toString(), albumart,
                new DisplayImageOptions.Builder().cacheInMemory(true)
                        .showImageOnFail(R.drawable.fireskullsmall)
