...
import com.cyberwolf.musicplayer.ITimberService;
import com.cyberwolf.musicplayer.MusicPlayer;
import com.cyberwolf.musicplayer.MusicService;
...
import com.cyberwolf.musicplayer.subfragments.QuickControlsFragment;
...
import static com.cyberwolf.musicplayer.MusicPlayer.mService;
...
public class BaseActivity extends ATEActivity implements ServiceConnection, MusicStateListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (!TimberUtils.hasEffectsPanel(BaseActivity.this)) {
            ...
            menu.removeItem(R.id.action_eq);
        }
