...
public class AlbumAdapter extends RecyclerView.Adapter<AlbumAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
        ...
        //ImageLoader.getInstance().displayImage(TimberUtils.getAlbumArtUri(localItem.id).toString(), itemHolder.albumArt, new DisplayImageOptions.Builder().cacheInMemory(true).build()
