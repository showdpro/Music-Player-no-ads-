    ...
    public void onBindViewHolder(ItemHolder itemHolder, int i) {
        ...
        if (MusicPlayer.getCurrentAudioId() == localItem.id) {
            ...
            if (MusicPlayer.isPlaying()) {
               ...
               // itemHolder.playingif.animate().alpha(1.0f).setDuration(500);
            }
        } else {
       ...
       // ImageLoader.getInstance().displayImage(TimberUtils.getAlbumArtUri(localItem.albumId).toString(), itemHolder.albumArt, new DisplayImageOptions.Builder().cacheInMemory(true).build());
