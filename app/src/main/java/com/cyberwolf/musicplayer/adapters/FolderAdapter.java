...
import com.cyberwolf.musicplayer.dataloaders.FolderLoader;
...
/*        for (Drawable d : mIcons){
    ...
    public void applyTheme(boolean dark) {
        ColorFilter wf = new PorterDuffColorFilter(Color.WHITE,PorterDuff.Mode.SRC_ATOP);
        ColorFilter cf = new PorterDuffColorFilter(Color.BLACK, PorterDuff.Mode.SRC_ATOP);
        for (Drawable d : mIcons) {
            if (dark) {
                d.setColorFilter(cf);
            } else {
