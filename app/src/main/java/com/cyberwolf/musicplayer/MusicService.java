...
import com.cyberwolf.musicplayer.helpers.MediaButtonIntentReceiver;
import com.cyberwolf.musicplayer.helpers.MusicPlaybackTrack;
import com.cyberwolf.musicplayer.lastfmapi.LastFmClient;
...
import com.cyberwolf.musicplayer.provider.MusicPlaybackState;
import com.cyberwolf.musicplayer.provider.RecentStore;
import com.cyberwolf.musicplayer.provider.SongPlayCount;
...
import com.cyberwolf.musicplayer.utils.TimberUtils.IdType;
...
public class MusicService extends Service {
    ...
    private Notification buildNotification() {
        ...
        if (artwork == null) {
            artwork = ImageLoader.getInstance().loadImageSync("drawable://" + R.drawable.fireskullsmall);
        }
