...
//import com.sdsmdg.harjot.MusicDNA.activities.HomeActivity; LOLOL
...
public class AnalogController extends View {
    ...
    void init() {
        ...
        // LOLOL textPaint.setTextSize(33 * HomeActivity.ratio);
      ...
      // LOLOL  circlePaint2.setColor(HomeActivity.themeColor);
//        circlePaint2.setColor(Color.parseColor("#FFA036"));
        circlePaint2.setStyle(Paint.Style.FILL);
        linePaint = new Paint();
       // LOLOL linePaint.setColor(HomeActivity.themeColor);
//        linePaint.setColor(Color.parseColor("#FFA036"));
     // LOLOL   linePaint.setStrokeWidth(7 * HomeActivity.ratio);
        angle = "0.0";
        label = "Label";
    }
