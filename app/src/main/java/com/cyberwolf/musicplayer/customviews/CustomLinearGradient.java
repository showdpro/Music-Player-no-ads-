...
// LOLOL import com.sdsmdg.harjot.MusicDNA.activities.HomeActivity;
...
public class CustomLinearGradient extends View {
    ...
    void init() {
        paint = new Paint();
        alpha = 140;
       // LOLOL  startColor = Color.argb(alpha, Color.red(HomeActivity.themeColor), Color.green(HomeActivity.themeColor), Color.blue(HomeActivity.themeColor));
