...
import com.cyberwolf.musicplayer.adapters.BaseQueueAdapter;
...
import com.cyberwolf.musicplayer.timely.TimelyView;
...
import com.cyberwolf.musicplayer.widgets.CircularSeekBar;
import com.cyberwolf.musicplayer.widgets.DividerItemDecoration;
import com.cyberwolf.musicplayer.widgets.PlayPauseButton;
import com.cyberwolf.musicplayer.widgets.PlayPauseDrawable;
...
public class BaseNowplayingFragment extends Fragment implements MusicStateListener {
    ...
    public void updateSongDetails() {
        ...
        if (!duetoplaypause) {
            songtitle.setTranslationX(100);
            songtitle.setAlpha(0.0f);
            songtitle.animate().translationX(0).alpha(1.0f).setDuration(2500);

            songartist.setTranslationX(100);
            songartist.setAlpha(0.0f);
            songartist.animate().translationX(0).alpha(1.0f).setDuration(3000);
