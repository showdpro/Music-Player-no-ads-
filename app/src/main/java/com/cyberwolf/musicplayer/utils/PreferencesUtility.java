...
public final class PreferencesUtility {
    ...
    private static final String AMBIENT_ENABLED = "enabled";
    ...
    public boolean ambientEnabled(){
        return mPreferences.getBoolean(AMBIENT_ENABLED,false);
    }
    ...
    public String getTheme() {
        return mPreferences.getString(THEME_PREFERNCE, "dark"); //used to be light LOLOL
    }
