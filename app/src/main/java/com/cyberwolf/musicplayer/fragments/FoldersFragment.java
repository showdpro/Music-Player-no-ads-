...
import com.cyberwolf.musicplayer.adapters.FolderAdapter;
import com.cyberwolf.musicplayer.dialogs.StorageSelectDialog;
import com.cyberwolf.musicplayer.utils.PreferencesUtility;
import com.cyberwolf.musicplayer.widgets.DividerItemDecoration;
import com.cyberwolf.musicplayer.widgets.FastScroller;
...
public class FoldersFragment extends Fragment implements StorageSelectDialog.OnDirSelectListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflator.inflate(R.layout.foldertitle, null);

//if you need to customize anything else about the text, do it here.
//I'm using a custom TextView with a custom font in my layout xml so all I need to do is set title
        ((TextView)v.findViewById(R.id.title)).setText("Folders");
        ((TextView)v.findViewById(R.id.title)).setTypeface(hero);
